...
<div class="div1" ><h1>Zakazivanje treninga</h1></div> <br><br><br>

<div class="row"  >
    <div class="div3">
        <button id="vidi"  class="btn_vidi" 
        s> Zakazani treninzi</button>
    </div><br>
...
<div  class="divp" >
    ...
    <div class="div6" >
        <table id="tabela" class="tabela" border="3" style=" background-color:rgb(43, 145, 185)">
            ...
            <tr >
                <th scope="kolona" style="background-color:rgb(43, 145, 185) " >Teretana</th>
                <th scope="kolona" style="background-color:rgb(43, 145, 185) " >Lokacija</th>
                <th scope="kolona" style="background-color:rgb(43, 145, 185) " >Datum</th>    
                <th scope="kolona" style="background-color:rgb(43, 145, 185) " >Vreme</th>
            </tr>
            </thead>
            <tbody>
            <?php
